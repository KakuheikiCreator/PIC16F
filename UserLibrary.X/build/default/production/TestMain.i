...
typedef enum {
    ...
    INPUT_MODE_CURRENT = 0x01,
    INPUT_MODE_FINAL = 0x02,
    INPUT_MODE_BUFFERING = 0x03
} teInputMode;
...
static unsigned char u8RxData;

static teInputMode eInputMode;

static unsigned char u8KeyValue;
# 138 "TestMain.c"
void main() {
    ...
    I2C_vInitSlaveSSP1((8), I2C_SLAVE_STD, ssp1_vCallback);
...
static void ssp2_vI2CTest03() {
    ...
    for (u8Cnt = 0; u8Cnt < 255; u8Cnt++) {
        ...
        I2C_u8MstStartSSP2((8), (1));
        u8Data = I2C_u8MstRxSSP2((1));
        I2C_vMstStopSSP2();
        if (u8Data != u8Cnt) {
            break;
        }
...
static void ssp2_vLCDTest01() {
    ...
    ST7032_vWriteCharSSP2(HEX_LIST[val >> 4 & 0x0F]);
    ST7032_vWriteCharSSP2(HEX_LIST[val & 0x0F & 0x0F]);
...
static void ssp2_vLCDTest02() {
    ...
    ST7032_vWriteCharSSP2(HEX_LIST[ST7032_u8GetCursorRowNoSSP2() & 0x0F]);
    ...
    for (u8Idx = 0; u8Idx < 16; u8Idx++) {
        ...
        if ((u8Idx % 2) == 0) {
            if (ST7032_bSetCursorSSP2(1, u8Idx) == (1)) {
                ST7032_vWriteCharSSP2(HEX_LIST[ST7032_u8GetCursorColNoSSP2() & 0x0F]);
            }
        } else {
    ...
    for (u8Idx = 0; u8Idx < 16; u8Idx++) {
        ...
        if ((u8Idx % 2) == 0) {
            if (ST7032_bSetCursorSSP2(1, 15 - u8Idx) == (1)) {
                ST7032_vWriteCharSSP2(HEX_LIST[ST7032_u8GetCursorColNoSSP2() & 0x0F]);
            }
        } else {
    ...
    _delay((unsigned long)((1000)*(16000000/4000.0)));
    ST7032_bSetCursorSSP2(0, 0);
    if (ST7032_bCursorLeftSSP2() == (0)) {
        ST7032_bSetCursorSSP2(0, 15);
        ST7032_vWriteCharSSP2('D');
    }

    _delay((unsigned long)((1000)*(16000000/4000.0)));
    if (ST7032_bSetCursorSSP2(1, 39) == (1)) {
        ST7032_bSetCursorSSP2(1, 0);
        ST7032_vWriteCharSSP2('E');
    }

    _delay((unsigned long)((1000)*(16000000/4000.0)));
    if (ST7032_bSetCursorSSP2(1, 40) == (0)) {
...
static void ssp2_vLCDTest03() {
    ...
    unsigned char u8BitMap[] = {0x11, 0x0A, 0x04, 0x15, 0x15, 0x04, 0x0A, 0x11};
...
static void ssp2_vLCDTest04() {
    ...
    unsigned char u8SVal;
    for (u8Addr = 0; u8Addr < 16; u8Addr++) {

        ST7032_bSetCursorSSP2(0, 12);
        ST7032_vWriteCharSSP2(HEX_LIST[u8Addr & 0x0F]);

        for (u8SVal = 0; u8SVal < 32; u8SVal++) {

            ST7032_bSetCursorSSP2(0, 14);
            ST7032_vWriteCharSSP2(HEX_LIST[u8SVal >> 4 & 0x0F]);
            ST7032_vWriteCharSSP2(HEX_LIST[u8SVal & 0x0F & 0x0F]);
