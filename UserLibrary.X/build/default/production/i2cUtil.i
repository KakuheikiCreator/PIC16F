...
static void vDmyCallback(unsigned char u8BusNo, unsigned char u8EvtType);
# 78 "i2cUtil.c"
static unsigned char bMstStartFlgSSP1 = (0);

static unsigned char bMstStartFlgSSP2 = (0);



static void (*pvSSP1Func)(unsigned char u8BusNo, unsigned char u8EvtType) = vDmyCallback;

static void (*pvSSP2Func)(unsigned char u8BusNo, unsigned char u8EvtType) = vDmyCallback;
# 116 "i2cUtil.c"
extern void I2C_vInitMasterSSP1(enum I2C_MasterMode eMode, unsigned char u8ClkDiv) {
...
# 192 "i2cUtil.c"
extern void I2C_vInitSlaveSSP1(unsigned char u8Address, enum I2C_SlaveMode eMode,
                            void (*pvCallback)(unsigned char u8BusNo, unsigned char u8EvtType)) {

    if (pvCallback != ((void*)0)) {
...
# 238 "i2cUtil.c"
extern void I2C_vInitSlaveSSP2(unsigned char u8Address, enum I2C_SlaveMode eMode,
                            void (*pvCallback)(unsigned char u8BusNo, unsigned char u8EvtType)) {
...
# 433 "i2cUtil.c"
extern unsigned char I2C_u8MstRxSSP1(unsigned char bNackFlg) {

    vMasterWaitSSP1();
    SSP1CON2bits.RCEN = 1;

    vMasterWaitSSP1();
    unsigned char u8Data = SSP1BUF;
...
# 464 "i2cUtil.c"
extern unsigned char I2C_u8MstRxSSP2(unsigned char bNackFlg) {

    vMasterWaitSSP2();
    SSP2CON2bits.RCEN = 1;

    vMasterWaitSSP2();
    unsigned char u8Data = SSP2BUF;
...
extern void I2C_vSlaveIsrSSP1() {
    ...
    if (SSP1IF == 1) {
        ...
        pvSSP1Func(1, ((SSP1STAT & 0b00100101) | (SSP1CON2 & 0b01000000)));
        SSP1IF = 0;
        SSP1CON1bits.CKP = 1;
    }
...
extern void I2C_vSlaveIsrSSP2() {
    ...
    if (SSP2IF == 1) {
        ...
        pvSSP2Func(2, ((SSP2STAT & 0b00100101) | (SSP2CON2 & 0b01000000)));
        SSP2IF = 0;
        SSP2CON1bits.CKP = 1;
    }
