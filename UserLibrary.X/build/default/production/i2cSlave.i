...
# 1 "./libcom.h" 1
# 83 "./libcom.h"
extern void vCriticalSecBegin();

extern void vCriticalSecEnd();
# 30 "./i2cSlave.h" 2
# 53 "./i2cSlave.h"
enum I2C_Mode {
    I2C_MODE_MASTER_HIGH,
    I2C_MODE_MASTER_STD,
    I2C_MODE_SLAVE_HIGH,
    I2C_MODE_SLAVE_STD
};
# 77 "./i2cSlave.h"
extern void vI2C_initSSP1(unsigned char u8Address,
                            enum I2C_Mode eMode,
                            void (*pvCallback)(unsigned char u8BusNo, unsigned char u8EvtType));

extern void vI2C_isrSSP1();


extern void vI2C_isrSSP2();
# 24 "i2cSlave.c" 2
...
# 74 "./keypad.h"
extern void vKEYPAD_init(tsKEYPAD_status *spStatus);

extern unsigned char bKEYPAD_updateBuffer();

extern unsigned char u8KEYPAD_bufferSize();

extern void vKEYPAD_clearBuffer();

extern unsigned char u8KEYPAD_readBuffer();

extern unsigned char u8KEYPAD_readLast();
# 26 "i2cSlave.c" 2
# 61 "i2cSlave.c"
static void (*pvSSP1Func)(unsigned char u8BusNo, unsigned char u8EvtType) = ((void*)0);

static void (*pvSSP2Func)(unsigned char u8BusNo, unsigned char u8EvtType) = ((void*)0);
# 86 "i2cSlave.c"
extern void vI2C_initSSP1(unsigned char u8Address, enum I2C_Mode eMode, void (*pvCallback)(unsigned char u8BusNo, unsigned char u8EvtType)) {

    pvSSP1Func = pvCallback;

    switch (eMode) {
        case I2C_MODE_SLAVE_HIGH:

            SSP1STAT= 0b00000000;
            break;
        case I2C_MODE_SLAVE_STD:
