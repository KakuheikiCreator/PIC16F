...
typedef struct {
 ...
 unsigned char u8CursorPos;

 unsigned char u8Settings;
} ST7032_state;
...
static void vExecCmdSSP1(unsigned char u8Cmd);

static void vExecCmdSSP2(unsigned char u8Cmd);



static void vExecCmdEndSSP1(unsigned char u8Cmd);

static void vExecCmdEndSSP2(unsigned char u8Cmd);



static unsigned char bSetCursorSSP1(unsigned char u8Pos);

static unsigned char bSetCursorSSP2(unsigned char u8Pos);
# 104 "st7032.c"
...
extern void ST7032_vInitSSP1() {
    ...
    I2C_u8MstStartSSP1((0x3E), (0));

    vExecCmdSSP1((0b00111001));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP1((0b00010100));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP1((0b01110000) | (stStateSSP1.u8Settings & 0x0F));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP1((0b01011000) | (stStateSSP1.u8Settings >> 4));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP1((0b01101100));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP1((0b00111000));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP1((0b00001000) | 0x04);
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP1((0b10000000));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdEndSSP1((0b00000001));
    _delay((unsigned long)(((1080))*(16000000/4000000.0)));
}
# 179 "st7032.c"
extern void ST7032_vInitSSP2() {
    ...
    I2C_u8MstStartSSP2((0x3E), (0));

    vExecCmdSSP2((0b00111001));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP2((0b00010100));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP2((0b01110000) | (stStateSSP2.u8Settings & 0x0F));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP2((0b01011000) | (stStateSSP2.u8Settings >> 4));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP2((0b01101100));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP2((0b00111000));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP2((0b00001000) | 0x04);
    _delay((unsigned long)(((26))*(16000000/4000000.0)));
    vExecCmdSSP2((0b00000100) | 0x02);
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdSSP2((0b10000000));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    vExecCmdEndSSP2((0b00000001));
    _delay((unsigned long)(((1080))*(16000000/4000000.0)));
}
# 233 "st7032.c"
extern void ST7032_vSetContrastSSP1(unsigned char u8Contrast) {

    unsigned char u8Val = u8Contrast & 0x3F;
...
extern void ST7032_vDispSettingSSP1(unsigned char bDisp, unsigned char bCursor, unsigned char bBlink) {
    ...
    vExecCmdEndSSP1((0b00001000) | (bDisp << 2) | (bCursor << 1) | bBlink);
    _delay((unsigned long)(((26))*(16000000/4000000.0)));
}
# 554 "st7032.c"
extern void ST7032_vDispSettingSSP2(unsigned char bDisp, unsigned char bCursor, unsigned char bBlink) {
    ...
    vExecCmdEndSSP2((0b00001000) | (bDisp << 2) | (bCursor << 1) | bBlink);
    _delay((unsigned long)(((26))*(16000000/4000000.0)));
}
# 578 "st7032.c"
extern unsigned char ST7032_u8GetCursorRowNoSSP1() {
...
extern unsigned char ST7032_bSetCursorSSP1(unsigned char u8RowNo, unsigned char u8ColNo) {
    ...
    if (u8RowNo > (1) || u8ColNo > (39)) {
        return (0);
    }

    unsigned char u8Addr = (u8RowNo * 40) + u8ColNo;
...
extern void ST7032_vWriteCGRAMSSP1(unsigned char u8CharNo, unsigned char* pu8BitMap) {
    ...
    vExecCmdSSP1((0b01000000) | ((u8CharNo << 3) & 0x38));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));

    I2C_u8MstTxSSP1((0x40));

    unsigned char *pu8WkMap = pu8BitMap;
    unsigned char u8Idx;
...
extern void ST7032_vWriteCGRAMSSP2(unsigned char u8CharNo, unsigned char* pu8BitMap) {
    ...
    vExecCmdSSP2((0b01000000) | ((u8CharNo << 3) & 0x38));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));
...
# 1036 "st7032.c"
extern void ST7032_vWriteDataSSP1(unsigned char* pcData, unsigned char u8Len) {

    I2C_u8MstStartSSP1((0x3E), (0));

    I2C_u8MstTxSSP1((0x40));

    unsigned char* pu8WkData = pcData;
    unsigned char u8Idx;
...
# 1073 "st7032.c"
extern void ST7032_vWriteDataSSP2(unsigned char* pcData, unsigned char u8Len) {
...
extern void ST7032_vWriteIconSSP1(unsigned char u8Addr, unsigned char u8Map) {
    ...
    vExecCmdSSP1((0b01000000) | (u8Addr & 0x0F));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));
...
extern void ST7032_vWriteIconSSP2(unsigned char u8Addr, unsigned char u8Map) {
    ...
    vExecCmdSSP2((0b01000000) | (u8Addr & 0x0F));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));
...
static unsigned char bSetCursorSSP1(unsigned char u8Pos) {
    ...
    unsigned char u8Addr = (u8Pos / 40) * 0x40 + (u8Pos % 40);

    I2C_u8MstStartSSP1((0x3E), (0));

    vExecCmdEndSSP1((0b10000000) | (u8Addr & 0x7F));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));
...
static unsigned char bSetCursorSSP2(unsigned char u8Pos) {
    ...
    vExecCmdEndSSP2((0b10000000) | (u8Addr & 0x7F));
    _delay((unsigned long)(((26))*(16000000/4000000.0)));
